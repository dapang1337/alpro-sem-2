...
main(){
	...
	if(pil==1){
		cout<<"Masukkan Jumlah Ayam Geprek : "; cin>>ageprek;
		bayar_1 = ageprek * 21000; 
		cout<<"Harga : "<<bayar_1<<endl;
	}else if(pil==2){
		cout<<"Masukkan Jumlah Ayam Goreng : "; cin>>agoreng;
		bayar_2 = agoreng * 17000;
		cout<<"Harga : "<<bayar_2<<endl;
	}else if(pil==3){
		cout<<"Masukkan Jumlah Udang Goreng : "; cin>>ug;
		bayar_3 = ug * 19000;
		cout<<"Harga : "<<bayar_3<<endl;
	}else if (pil==4){
		cout<<"Masukkan Jumlah Cumi Goreng : "; cin>>cg;
		bayar_4 = cg * 20000;
		cout<<"Harga : "<<bayar_4<<endl;
	}else if(pil==5){
		cout<<"Masukkan Jumlah Ayam Bakar : "; cin>>ab;
		bayar_5 = ab * 25000;
	...
	{
		cout<<"=======================================\n";
		cout<<"Selamat Anda Dapat Diskon 15%"<<endl;
		...
		cout<<"=========================================\n";
		cout<<"Selamat Anda Dapat Diskon 35%"<<endl;
